  ...
  return (
    <div className="w-full max-w-sm">
      <div className="text-center mb-8">
        ...
        <h1 className="mt-5 text-xl font-semibold text-text-primary">Welcome back</h1>
      ...
      <p className="mt-5 text-center text-sm text-text-muted">
        ...
        <Link href="/signup" className="text-accent-primary hover:underline underline-offset-4">
          Sign up
        </Link>
      </p>
    </div>
